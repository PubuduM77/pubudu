        ...
        <h3>Labor Registration</h3>
            ...
            <div class="card text-center">
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="labor_reg_personal_info.php">Personal Information</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body">
                    <form action="" method="" class="g-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-primary" href="labor_reg_personal_info.php" role="button" style="width: 120px;">&laquo;Previous</a>
                            </div>
                            <div class="col-2">
