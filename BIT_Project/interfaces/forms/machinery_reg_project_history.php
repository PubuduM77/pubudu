        ...
        <h3>Machinery Registration</h3>
            ...
            <div class="card text-center">
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="machinery_reg_general_info.php">General Information</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <form action="" method="" class="g-3">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-10 col-md-4">
                                <input type="text" class="form-control" id="operatorName" name="operatorName" placeholder="Operator Name:"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-primary" href="machinery_reg_general_info.php" role="button" style="width: 120px;">&laquo;Previous</a>
                            </div>
                            <div class="col-2">
