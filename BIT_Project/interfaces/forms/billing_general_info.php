        ...
        <h3>Billing Form</h3>
            ...
            <div class="card text-center">        <!-- size reduce must -->
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="billing_entries.php">Entries</a>
                    </li>
                    </ul>
                </div>
                ...
                <div class="card-body">
                    <form action="" method="" class="g-3">
                        <div class="row">        <!-- do we need the calendar picture to attached-->
                            <div class="col-2">
                                <input placeholder="Billing Date:" class="textbox-n form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="billDate"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3 col-sm-3 col-md-3">   <!-- add a datalist maybe -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-primary" href="billing_entries.php" role="button" style="width: 120px;">Next&raquo;</a>
                            </div>
                        </div>
